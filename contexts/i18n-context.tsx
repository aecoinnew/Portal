...
const messages: Record<string, { en: string; ar: string }> = {
  ...
  "pw.strength": { en: "Password strength", ar: "قوة كلمة المرور" },
  "pw.s0": { en: "Very weak", ar: "ضعيفة جداً" },
  "pw.s1": { en: "Weak", ar: "ضعيفة" },
  "pw.s2": { en: "Fair", ar: "مقبولة" },
  "pw.s3": { en: "Good", ar: "جيدة" },
  "pw.s4": { en: "Strong", ar: "قوية" },
  "pw.reqLength": { en: "At least 12 characters", ar: "١٢ حرفاً على الأقل" },
  "pw.reqLower": { en: "A lowercase letter", ar: "حرف صغير" },
  "pw.reqUpper": { en: "An uppercase letter", ar: "حرف كبير" },
  "pw.reqDigit": { en: "A number", ar: "رقم" },
  "pw.reqSymbol": { en: "A symbol", ar: "رمز" },
  "pw.hint": { en: "Use 12+ characters with a mix of letters, numbers, and symbols.", ar: "استخدم ١٢ حرفاً فأكثر مع مزيج من الحروف والأرقام والرموز." },
  // assistant widget
